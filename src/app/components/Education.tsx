        ...
        {educationData.map((edu, index) => (
          ...
          >
            ...
            <div className="flex-grow">
              ...
              <p className="text-sm sm:text-base font-body text-gray-600 dark:text-gray-400 mb-4">
                {edu.period}
              </p>

              {/* CGPA */}
              {edu.cgpa && (
                <p className="text-sm sm:text-base font-body text-gray-700 dark:text-gray-300 mb-4">
              ...
              <div className="mt-4">
                <p className="font-heading text-lg sm:text-xl font-medium mb-2">
