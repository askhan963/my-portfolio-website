...
export const TOAST_MESSAGES = {
  ...
  EXPERIENCE: {
    FETCH_ERROR: 'Failed to fetch experience',
  ...
  HONORS: {
    FETCH_ERROR: 'Failed to fetch honors',
    CREATE_SUCCESS: 'Honor created successfully!',
    CREATE_ERROR: 'Failed to create honor',
    UPDATE_SUCCESS: 'Honor updated successfully!',
    UPDATE_ERROR: 'Failed to update honor',
    DELETE_SUCCESS: 'Honor deleted successfully!',
    DELETE_ERROR: 'Failed to delete honor',
  },
  GENERAL: {
